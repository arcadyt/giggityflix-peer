...
class TestApiServer:
    ...
    def api_server(self):
        ...
        with mock.patch("src.api.server.config") as mock_config:
    ...
    async def test_start_and_stop(self, api_server):
        ...
        with mock.patch("src.api.server.web.AppRunner") as mock_app_runner, \
             mock.patch("src.api.server.web.TCPSite") as mock_tcp_site:
    ...
    async def test_handle_get_media(self, api_server):
        ...
        with mock.patch("src.api.server.db_service") as mock_db_service:
            # Configure mock
    ...
    async def test_handle_create_stream(self, api_server):
        ...
        with mock.patch("src.api.server.stream_service") as mock_stream_service:
            # Configure mock
    ...
    async def test_handle_capture_screenshots(self, api_server):
        ...
        # Mock the services
        with mock.patch("src.api.server.db_service") as mock_db_service, \
             mock.patch("src.api.server.screenshot_service") as mock_screenshot_service:
