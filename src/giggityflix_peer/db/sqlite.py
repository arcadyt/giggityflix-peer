...
class Database:
    ...
    async def execute_and_fetchall(self, query: str, params: Union[Tuple, Dict[str, Any], None] = None) -> List[sqlite3.Row]:
    ...
    async def execute_and_fetchone(self, query: str, params: Union[Tuple, Dict[str, Any], None] = None) -> Optional[sqlite3.Row]:
