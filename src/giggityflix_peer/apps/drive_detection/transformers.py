...
from giggityflix_peer.apps.drive_detection.models import Partition as OrmPartition
# Import ORM models
from giggityflix_peer.apps.drive_detection.models import PhysicalDrive as OrmDrive
